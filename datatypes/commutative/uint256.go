...
var (
	U256_ZERO = (*codec.Uint256)(uint256.NewInt(0))
	U256_ONE  = (*codec.Uint256)(uint256.NewInt(1))

	U256_MIN = (*codec.Uint256)(uint256.NewInt(0)) // default limits
	U256_MAX = (*codec.Uint256)(uint256.NewInt(0).SetAllOne())
)
...
func NewU256(limits ...*uint256.Int) interface{} {
	limits = common.IfThen(len(limits) == 0, []*uint256.Int{(*uint256.Int)(U256_MIN), (*uint256.Int)(U256_MAX)}, limits)
	...
	return &U256{
		...
		min:           common.IfThen(limits[0] != nil, (*codec.Uint256)(limits[0].Clone()), U256_MIN.Clone().(*codec.Uint256)),
		max:           common.IfThen(limits[1] != nil, (*codec.Uint256)(limits[1].Clone()), U256_MAX.Clone().(*codec.Uint256)),
...
func (this *U256) New(value, delta, sign, min, max interface{}) interface{} {
	return &U256{
		value:         common.IfThenDo1st(value != nil, func() interface{} { return value }, U256_ZERO.Clone()).(*codec.Uint256),
		delta:         common.IfThenDo1st(delta != nil, func() interface{} { return delta.(*codec.Uint256) }, U256_ZERO.Clone()).(*codec.Uint256),
		deltaPositive: common.IfThenDo1st(sign != nil, func() bool { return sign.(bool) }, true),
		min:           common.IfThenDo1st(min != nil, func() interface{} { return min }, U256_ZERO.Clone()).(*codec.Uint256),
		max:           common.IfThenDo1st(max != nil, func() interface{} { return max }, U256_MAX.Clone()).(*codec.Uint256),
	}
...
func (this *U256) ResetDelta()                { this.SetDelta((U256_ZERO.Clone().(*codec.Uint256))) }
...
func (this *U256) Equal(other interface{}) bool {
	return common.Equal(this.value, other.(*U256).value, func(v *codec.Uint256) bool { return v.Eq(U256_ZERO) }) &&
		common.Equal(this.delta, other.(*U256).delta, func(v *codec.Uint256) bool { return v.Eq(U256_ZERO) }) &&
		common.Equal(this.min, other.(*U256).min, func(v *codec.Uint256) bool { return v.Eq(U256_ZERO) }) &&
