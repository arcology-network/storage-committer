...
func TestAddAndDelete(t *testing.T) {
	...
	if acctTrans := univalue.Univalues(common.Clone(url.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...); len(acctTrans) != 0 {
...
func TestRecursiveDeletionSameBatch(t *testing.T) {
	...
	path := commutative.NewPath()
	_ = url.Write(1, "blcc://eth1.0/account/"+alice+"/storage/ctrn-0/", path)
	// _, addPath := url.Export(univalue.Sorter)
	addPath := univalue.Univalues(common.Clone(url.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...)
	...
	// _, addTrans := url.Export(univalue.Sorter)
	addTrans := univalue.Univalues(common.Clone(url.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...)
	...
	// _, deleteTrans := url2.Export(univalue.Sorter)
	deleteTrans := univalue.Univalues(common.Clone(url2.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...)
...
func TestRecursiveDeletionDifferentBatch(t *testing.T) {
	...
	if acctTrans := univalue.Univalues(common.Clone(url.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...); len(acctTrans) != 3 {
		t.Error("Error: Wrong number of transitions")
	}
}
...
func TestStateUpdate(t *testing.T) {
	...
	// _, initTrans := url.Export(univalue.Sorter)
	initTrans := univalue.Univalues(common.Clone(url.Export(univalue.Sorter))).To(univalue.TransitionCodecFilterSet()...)
