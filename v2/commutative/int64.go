...
func NewInt64(min, max int64) interface{} {
	...
	value := codec.Int64(0)
	delta := codec.Int64(0)
	minV := codec.Int64(min)
	maxV := codec.Int64(max)
	return &Int64{
		&value,
		&delta,
		&minV,
...
func (this *Int64) New(value, delta, sign, min, max interface{}) interface{} {
	common.IfThenDo(value != nil, func() { this.value = value.(*codec.Int64) }, nil)
	common.IfThenDo(delta != nil, func() { this.delta = delta.(*codec.Int64) }, nil)
	common.IfThenDo(min != nil, func() { this.min = min.(*codec.Int64) }, nil)
	common.IfThenDo(max != nil, func() { this.max = max.(*codec.Int64) }, nil)
	return this
}

func (this *Int64) Value() interface{} { return this.value }
func (this *Int64) Delta() interface{} { return this.delta }
func (this *Int64) Sign() interface{}  { return *this.delta >= 0 }
