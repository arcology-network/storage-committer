...
func (this *U256) isOverflowed(v0 *codec.Uint256, signV0 bool, v1 *codec.Uint256, signV1 bool) (*codec.Uint256, bool) {
	if signV0 == signV1 { // Both positive or negative
		summed, overflowed := ((*uint256.Int)(v0)).AddOverflow((*uint256.Int)(v0), (*uint256.Int)(v1))
		if overflowed {
			return nil, true
		}
		return (*codec.Uint256)(summed), signV0
	}
