...
func PathIndexer(store interfaces.ReadOnlyDataStore) *indexer.UnorderedIndexer[string, *univalue.Univalue, []*univalue.Univalue] {
...
func TxIndexer(store interfaces.ReadOnlyDataStore) *indexer.UnorderedIndexer[uint32, *univalue.Univalue, []*univalue.Univalue] {
	return indexer.NewUnorderedIndexer(
		nil,
