...
func (this *MetaDelta) Encode(processors ...func(interface{}) interface{}) []byte {
...
func (this *MetaDelta) EncodeToBuffer(buffer []byte, processors ...func(interface{}) interface{}) int {
