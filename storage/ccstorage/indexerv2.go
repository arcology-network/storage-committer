...
// An index by account address, transitions have the same Eth account address will be put together in a list
// This is for ETH storage, concurrent container related sub-paths won't be put into this index.
func (this *CCIndexerV2) Add(transitions []*univalue.Univalue) {
...
func (this *CCIndexerV2) Get() interface{} {
...
func (this *CCIndexerV2) Finalize() {
	...
	kvs := this.Get().([]interface{})
	this.keyBuffer, this.valueBuffer = kvs[0].([]string), kvs[1].([]interface{})
