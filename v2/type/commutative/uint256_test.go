...
// 	if _, _, _, _, err := balance.Set( NewU256(nil, big.NewInt(-2)), nil); err != nil {
// 		t.Error(err)
// 	}

// 	if _, _, _, _, err := balance.Set( NewU256(nil, big.NewInt(-1)), nil); err != nil {
// 		t.Error(err)
// 	}

// 	if _, _, _, _, err := balance.Set( NewU256(nil, big.NewInt(3)), nil); err != nil {
// 		t.Error(err)
// 	}
