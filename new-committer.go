...
type StateCommitterV2 struct {
	...
	byCtrn *Indexer[string, *univalue.Univalue, *[]*univalue.Univalue]
}
...
func NewStorageCommitterV2(store interfaces.Datastore) *StateCommitterV2 {
	...
	init := func(_ string, v *univalue.Univalue) *[]*univalue.Univalue {
	...
	return &StateCommitterV2{
		...
		byPath: NewIndexer(
			...
			nil,
			init,
			func(_ string, v *univalue.Univalue, vals **[]*univalue.Univalue) {
				**vals = append(**vals, v)
			},
		),
		...
		byTxID: NewIndexer(
			...
			nil,
			func(_ uint32, v *univalue.Univalue) *[]*univalue.Univalue {
				return &[]*univalue.Univalue{v}
			},
			func(_ uint32, v *univalue.Univalue, vals **[]*univalue.Univalue) {
				**vals = append(**vals, v)
			},
		),
...
func (this *StateCommitterV2) Precommit(txs []uint32) [32]byte {
	...
	// Write the concurrent transitions to the concurrent container storage
...
// Commit commits the transitions in the StateCommitterV2.
func (this *StateCommitterV2) Commit() *StateCommitterV2 {
