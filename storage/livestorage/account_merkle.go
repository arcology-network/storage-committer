...
// 		p0 := current[:stgcommon.ETH10_ACCOUNT_PREFIX_LENGTH+stgcommon.ETH10_ACCOUNT_LENGTH]
// 		p1 := paths[i][:stgcommon.ETH10_ACCOUNT_PREFIX_LENGTH+stgcommon.ETH10_ACCOUNT_LENGTH]
// 		if p0 != p1 {
// 			current = paths[i]
